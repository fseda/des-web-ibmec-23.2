...
function getAtletasFeminino(atletas: Player[]): Player[] {
  return atletas.filter(atleta => atleta.elenco === "feminino");
}

function getAtletasMasculino(atletas: Player[]): Player[] {
  return atletas.filter(atleta => atleta.elenco === "masculino");
}

function getAtletaById(atletas: Player[], id: number): Player {
