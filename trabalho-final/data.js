...
function getAtletasFeminino(atletas) {
    return atletas.filter(function (atleta) { return atleta.elenco === "feminino"; });
}
function getAtletasMasculino(atletas) {
    return atletas.filter(function (atleta) { return atleta.elenco === "masculino"; });
}
function getAtletaById(atletas, id) {
    return atletas.filter(function (atleta) { return atleta.id === id; })[0];
}
