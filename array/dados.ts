...
function getAtletasFeminino(atletas: IAtleta[]): IAtleta[] {
  return atletas.filter(atleta => atleta.elenco === "feminino");
}

function getAtletasMasculino(atletas: IAtleta[]): IAtleta[] {
  return atletas.filter(atleta => atleta.elenco === "masculino");
}

function getAtletaById(atletas: IAtleta[], id: number): IAtleta {
